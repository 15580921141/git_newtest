...
import xlrd
def testexcle(keynum):
    data = xlrd.open_workbook('20170815.xls')
    table = data.sheets()[0]
    nrows = table.nrows
                ...
                while True:
                    ...
                    if line:
                        ...
                        if str(line).startswith("Request url"):
                            ...
                            print "-----------------------------------------"
                            print (decode_base64(str(line).split("=")[1]).split("\t"))

                            buttonnum=(decode_base64(str(line).split("=")[1]).split("\t"))[8]
...
if __name__ == '__main__':
    ...
    print decode_base64("NTg4MEFCQzUtODUyNy00N0NFLUJERDEtQzM0Njg2QTY3N0VDCUFwcFN0b3JlMTcwODE4CXRpYW5xaQlUUVlCSU9TCTEuMy4zCWlPUwk5LjIJQzk0M0QwNUEtNDlGRC00MzE5LTkyOEQtOTdDMUI2NEVGQ0E5CUUxNQludWxsCTAxMDMwMwludWxsCVRRWUI")
    # py_tail = Tail('D:\\Fiddler Sessions\Api\\123.59.60.170\\123.txt')
    # py_tail.follow()
